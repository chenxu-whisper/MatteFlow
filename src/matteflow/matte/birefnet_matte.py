...
class BiRefNetMatte:
    ...
    def _load_model(self):
        ...
        try:
            ...
            try:
                self.model = self._from_pretrained(AutoModelForImageSegmentation, "main")
            except Exception as e1:
                print(f"[BiRefNet] Main revision failed: {e1}")
                print("[BiRefNet] Trying legacy revision...")
                # 尝试旧版本
                self.model = self._from_pretrained(AutoModelForImageSegmentation, "v1.0")
    ...
    def _from_pretrained(self, model_loader, revision: str):
        kwargs = {
        ...
        with warnings.catch_warnings():
            ...
            try:
                return model_loader.from_pretrained("ZhengPeng7/BiRefNet", **kwargs)
